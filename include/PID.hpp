...
public:
    ...
    void initializePID(const Eigen::Matrix<double, 6, 1> state, double target_angle);
    ...
    double calculate_derivative(const Eigen::Matrix<double, 6, 1> state) const;
    ...
    double step(double dt, const Eigen::Matrix<double, 6, 1> state, const Engine& engine, double target_angle);
};